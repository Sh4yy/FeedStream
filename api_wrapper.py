...
class FeedStreamClient:
    ...
    def publish(self, producer_id: str, item_id: str, verb: str,
    ...
    def subscribe(self, event_name: str, producer_id: str, consumer_id: str):
        """
    ...
    def unsubscribe(self, event_name: str, producer_id: str, consumer_id: str):
        """
    ...
    def consume(self, event_name: str, consumer_id: str, limit: int = 20,
